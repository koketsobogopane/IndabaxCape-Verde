...
export const commentSectionData = {
  ...
  description:
    "Here's what attendees and participants have to say about their IndabaX experience.",
  comments: [
    {
      name: 'Aisha Keita',
      imageUrl: 'comment-1.jpg', // Unique ID with .jpg
      comment:
        'IndabaX was a transformative experience! The workshops were incredibly informative, and the networking opportunities were invaluable.',
    },
    {
      name: 'David Obi',
      imageUrl: 'comment-2.jpg', // Unique ID with .jpg
      comment:
        'The conference provided a great platform to learn about the latest advancements in AI and connect with leading experts in the field.',
    },
    {
      name: 'Sarah Williams',
      imageUrl: 'comment-3.jpg', // Unique ID with .jpg
      comment:
        "I was impressed by the diversity of speakers and attendees. It's inspiring to see so much talent and passion for AI in Africa.",
    },
    {
      name: 'Samuel Johnson',
      imageUrl: 'comment-4.jpg', // Unique ID with .jpg
      comment:
        "The organizers did a fantastic job. Everything was well-planned, and the event ran smoothly. I'm looking forward to the next one!",
    },
    {
      name: 'Nadia Ahmed',
      imageUrl: 'comment-5.jpg', // Unique ID with .jpg
      comment:
        "IndabaX is more than just a conference; it's a community. I felt welcomed and inspired by everyone I met.",
    },
    {
      name: 'Jean-Pierre',
      imageUrl: 'comment-6.jpg', // Unique ID with .jpg
      comment:
        'It was an eye-opening experience. I learned so much about the potential of AI to solve real-world problems in Africa.',
    },
  ],
};
...
export const indabaXEventDate = '2026-10-26T09:00:00+02:00';

export const eventsData = [
  {
    id: 'indabax-capetown-2025',
    imageUrl:
      'https://placehold.co/600x400/2C5282/FFFFFF/png?text=IndabaX+CT+2025', // Using brand-secondary for placeholder background
    date: '25 - 28 October 2025',
    location: 'Cape Town Convention Centre, South Africa',
    title: 'IndabaX Cape Town 2025: AI for Sustainable Futures',
    description:
      'Join leading AI researchers, practitioners, and enthusiasts from across Africa for four days of intensive learning, collaboration, and innovation focusing on sustainable development.',
    buttonText: 'Register Now',
    buttonLink: '/register/capetown2025', // Specific link for this event
  },
  {
    id: 'indabax-nairobi-2026',
    imageUrl:
      'https://placehold.co/600x400/319795/FFFFFF/png?text=IndabaX+Nairobi+2026', // Using brand-accent for placeholder background
    date: '10 - 12 March 2026',
    location: 'Kenyatta International Convention Centre, Kenya',
    title: 'IndabaX Nairobi 2026: Advancing Healthcare AI',
    description:
      'Explore the cutting-edge of AI applications in healthcare, from diagnostics to personalized medicine, tailored for the African context.',
    buttonText: 'Learn More',
    buttonLink: '/events/nairobi2026',
  },
  {
    id: 'indabax-virtual-workshop-2026',
    imageUrl:
      'https://placehold.co/600x400/2C5282/FFFFFF/png?text=Virtual+Workshop+2026', // Using brand-secondary for placeholder background
    date: '15 June 2026',
    location: 'Online (Virtual Event)',
    title: 'Virtual Workshop: Ethical AI Development in Africa',
    description:
      'A one-day online workshop dedicated to discussing and shaping ethical guidelines for AI development and deployment across the African continent.',
    buttonText: 'View Details',
    buttonLink: '/events/virtualworkshop2026',
  },
  {
    id: 'indabax-lagos-2026',
    imageUrl:
      'https://placehold.co/600x400/319795/FFFFFF/png?text=IndabaX+Lagos+2026', // Using brand-accent for placeholder background
    date: '18 - 20 November 2026',
    location: 'Eko Convention Centre, Nigeria',
    title: 'IndabaX Lagos 2026: AI in Finance and Entrepreneurship',
    description:
      'Focusing on the role of AI in revolutionizing financial services and fostering a new wave of AI-driven entrepreneurship in Africa.',
    buttonText: 'Coming Soon',
    buttonLink: '#', // No active link yet
  },
];

export const indabaXCaboVerdeFAQs = [
  {
    question: 'What is Deep Learning IndabaX Cabo Verde?',
    answer:
      'Deep Learning IndabaX Cabo Verde is an annual regional event organized in conjunction with the Deep Learning Indaba. It aims to strengthen the African AI community by providing world-class deep learning education, fostering collaborations, and showcasing local research and applications, specifically for the community in Cabo Verde and surrounding Lusophone African countries.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'IndabaX Cabo Verde 2025 is scheduled for [Specific Dates, e.g., November 15-17, 2025] at [Specific Venue, e.g., University of Cabo Verde, Praia]. Please check our official website for the most up-to-date information on dates and venue.',
  },
  {
    question: 'What topics will be covered in the program?',
    answer:
      "The program typically includes tutorials on deep learning fundamentals, advanced research talks, hands-on workshops, poster sessions for local research, and panel discussions on AI's impact in Africa. Topics range from computer vision and natural language processing to reinforcement learning and ethical AI development.",
  },
  {
    question: 'How do I register for IndabaX Cabo Verde?',
    answer:
      'Registration details will be announced on our website. Generally, it involves filling out an online form and completing payment (if applicable). Early bird registration discounts are often available. Please subscribe to our newsletter for direct notifications.',
  },
  {
    question: 'Are there any registration fees?',
    answer:
      'Registration fees vary by attendee type (e.g., student, academic, industry professional) and registration period (early bird vs. standard). We strive to keep fees affordable to ensure broad accessibility. Specific fee structures will be published on the registration page.',
  },
  {
    question: 'Are scholarships or financial aid available?',
    answer:
      'IndabaX Cabo Verde is committed to inclusivity. We often offer a limited number of scholarships or financial aid options to support participants, especially students, who might face financial barriers. Details on how to apply for such assistance will be provided on the registration page.',
  },
  {
    question: 'How can I submit my research or project?',
    answer:
      "We welcome submissions from the local and regional AI community. Guidelines for research paper, poster, or project submissions, along with deadlines, will be made available on the 'Call for Papers/Posters' section of our website closer to the event date. Keep an eye on our announcements!",
  },
  {
    question: 'Can I volunteer for IndabaX Cabo Verde?',
    answer:
      'Yes, volunteers are crucial to the success of IndabaX! We will open applications for volunteers closer to the event. This is a great way to contribute to the community, gain experience, and network. Details on roles and application process will be announced.',
  },
  {
    question: 'What safety measures are in place for in-person attendance?',
    answer:
      'The health and safety of our attendees are paramount. We will adhere to all local health guidelines and may implement additional measures such as mask mandates, social distancing, enhanced sanitization, and vaccination requirements as necessary. Specific protocols will be communicated closer to the event.',
  },
  {
    question: 'Who are the key organizers of IndabaX Cabo Verde?',
    answer:
      'Deep Learning IndabaX Cabo Verde is organized by a dedicated committee of local AI enthusiasts, academics, and researchers, with support from the Deep Learning Indaba leadership. Our goal is to build a self-sustaining and thriving AI community in Cabo Verde.',
  },
  {
    question:
      "How can I contact the organizers if my question isn't listed here?",
    answer:
      'If your question is not covered in this FAQ, please feel free to reach out to us through our contact page or by emailing [Your IndabaX Cabo Verde Email Address, e.g., info@indabaxcv.org]. We aim to respond within 48 hours.',
  },
];
...
export const blogPosts = [
  {
    id: 1,
    imageUrl: 'ai-ethics-africa.jpg', // Updated imageUrl
    title: 'Navigating Ethical AI in Africa: A Local Perspective',
    excerpt:
      'Exploring the unique challenges and opportunities in developing ethical AI frameworks tailored for African contexts...',
    date: 'May 15, 2025',
    link: '/blog/ai-ethics-africa',
    category: 'AI Ethics',
  },
  {
    id: 2,
    imageUrl: 'african-nlp-research.jpg', // Updated imageUrl
    title: 'Advancements in African Language NLP Research',
    excerpt:
      'Recent breakthroughs are enabling natural language processing to better understand and generate content in diverse African languages...',
    date: 'May 10, 2025',
    link: '/blog/african-nlp',
    category: 'Research',
  },
  {
    id: 3,
    imageUrl: 'student-spotlight-indabax.jpg', // Updated imageUrl
    title: 'Student Spotlight: My IndabaX Journey to Machine Learning',
    excerpt:
      'Hear from a past IndabaX Cabo Verde delegate about their transformative experience and career growth in AI...',
    date: 'May 01, 2025',
    link: '/blog/student-journey',
    category: 'Community',
  },
  {
    id: 4,
    imageUrl: 'ai-for-development-caboverde.jpg', // Updated imageUrl
    title: 'AI for Development: Solutions for Cabo Verde',
    excerpt:
      'How AI technologies are being deployed to address critical development challenges in Cabo Verde, from agriculture to healthcare...',
    date: 'April 28, 2025',
    link: '/blog/ai-for-cv-dev',
    category: 'Impact',
  },
  {
    id: 5,
    imageUrl: 'generative-ai-workshop-highlights.jpg', // Updated imageUrl
    title: 'Highlights from the Generative AI Workshop',
    excerpt:
      'A recap of our recent hands-on workshop, exploring the latest tools and techniques in generative artificial intelligence...',
    date: 'April 20, 2025',
    link: '/blog/generative-ai-workshop',
    category: 'Workshops',
  },
  {
    id: 6,
    imageUrl: 'interview-ai-climate-change.jpg', // Updated imageUrl
    title: 'Interview with Dr. Sofia Mendes: AI and Climate Change',
    excerpt:
      'A deep dive into how AI can be leveraged to combat climate change effects, featuring insights from our keynote speaker...',
    date: 'April 12, 2025',
    link: '/blog/sofia-mendes-interview',
    category: 'Interviews',
  },
