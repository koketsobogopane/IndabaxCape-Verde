...
import { ArrowLeft, PersonCircle, CalendarEvent, Tag } from 'react-bootstrap-icons';
...
const SingleBlogPostPageTemplate = () => {
    ...
    const allBlogPosts = [
        {
            id: 'ai-ethics-africa',
            imageUrl: 'https://via.placeholder.com/1200x600/94a3b8/ffffff?text=AI+Ethics+in+Africa',
        ...
        {
            id: 'african-nlp',
            imageUrl: 'https://via.placeholder.com/1200x600/a78bfa/ffffff?text=African+Language+NLP',
        ...
        {
            id: 'student-journey',
            imageUrl: 'https://via.placeholder.com/1200x600/fb923c/ffffff?text=Student+Success+Story',
            ...
            >
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 text-white">
                    ...
                    <div className="flex items-center text-lg text-gray-200">
                        <PersonCircle className="mr-2" /> <span className="mr-4">{post.author}</span>
            ...
            <section className="py-12 sm:py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-200 flex flex-wrap gap-4 items-center justify-center">
                        <span className="text-lg font-semibold text-gray-700 mr-4">Share this post:</span>
                        {/* Replace with actual share links/buttons */}
                        <a href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(window.location.href)}&title=${encodeURIComponent(post.title)}`} target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-blue-800 text-3xl transition-colors"><i className="fab fa-linkedin" /></a>
                        <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(post.title)}`} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-500 text-3xl transition-colors"><i className="fab fa-twitter-square" /></a>
                        <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 text-3xl transition-colors"><i className="fab fa-facebook-square" /></a>
