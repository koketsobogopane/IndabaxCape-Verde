  ...
  return (
    ...
    <div className="bg-brand-primary min-h-screen">
      ...
      <section className="py-16 text-white">
        {' '}
        {/* text-white is good for this dark section */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-12">
              ...
              <div className="bg-brand-secondary p-6 rounded-lg shadow-md text-center flex-1 min-w-[200px] max-w-[300px]">
                ...
                <p className="text-xl font-semibold text-brand-accent mb-2">
                  Student
                </p>
            ...
            <p className="text-neutral-medium text-sm italic">
              All fees are in South African Rand (ZAR) and include access to all
              main conference sessions, workshops, and networking events.
          ...
          <div className="text-center mt-12 text-neutral-medium text-sm">
            <p>
              After submitting the form, you will be redirected to our secure
              payment portal.
            </p>
            <p className="mt-2">
              For any questions, please visit our{' '}
              <a href="/faq" className="text-brand-accent hover:underline">
                FAQ section
              </a>{' '}
              or{' '}
