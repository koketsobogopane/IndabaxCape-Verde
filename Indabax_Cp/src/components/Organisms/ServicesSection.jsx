    ...
    <section className="py-16 bg-white relative text-left overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Link
            to="/about"
            className="block relative h-72 rounded-lg shadow-lg overflow-hidden group"
          >
            {' '}
            {/* Added h-72 for fixed card height */}
            <img
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 lg:gap-16">
          <img
            src={partnerLogo1}
            alt="Partner Logo 1"
            className="h-12 md:h-16 opacity-75 hover:opacity-100 transition-opacity duration-300"
          />
          <img
            src={partnerLogo2}
            alt="Partner Logo 2"
