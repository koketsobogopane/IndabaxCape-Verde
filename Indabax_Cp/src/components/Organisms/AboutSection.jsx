...
function AboutSection({ description, cards = [], title }) {
  return (
    <section className="relative py-16 bg-white dark:bg-gray-900">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                {/* Description */}
                <div className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-12 max-w-3xl mx-auto text-center">
                    {description}
                </div>
