...
import { Person, Envelope, Phone, Building, Book, Award, ChevronDown } from 'react-bootstrap-icons';
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <label htmlFor="firstName" className="block text-neutral-medium text-sm font-semibold mb-2">First Name</label>
                    ...
                    <div>
                        <label htmlFor="lastName" className="block text-neutral-medium text-sm font-semibold mb-2">Last Name</label>
                        <div className="relative">
                            <input
                                type="text"
                                id="lastName"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label htmlFor="email" className="block text-neutral-medium text-sm font-semibold mb-2">Email Address</label>
                        <div className="relative">
                            <input
                                type="email"
                                id="email"
                    ...
                    <div>
                        <label htmlFor="phone" className="block text-neutral-medium text-sm font-semibold mb-2">Phone Number (Optional)</label>
                        <div className="relative">
                            <input
                                type="tel"
                                id="phone"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label htmlFor="institution" className="block text-neutral-medium text-sm font-semibold mb-2">Institution/Affiliation</label>
                        <div className="relative">
                            <input
                                type="text"
                                id="institution"
                    ...
                    <div>
                        <label htmlFor="country" className="block text-neutral-medium text-sm font-semibold mb-2">Country</label>
                        <div className="relative">
                            <select
                                id="country"
                                name="country"
                ...
                <div className="mb-6">
                    ...
                    <label className="block text-neutral-medium text-sm font-semibold mb-2">I am attending as a:</label>
                    <div className="flex flex-wrap gap-4">
                        ...
                        <label className="inline-flex items-center text-neutral-medium">
                            ...
                            />
                            <span className="ml-2 flex items-center"><Book className="mr-1" /> Student</span>
                        </label>
                        <label className="inline-flex items-center text-neutral-medium">
                            <input
                                type="radio"
                                ...
                                className="form-radio h-4 w-4 text-brand-accent bg-brand-primary border-brand-secondary focus:ring-brand-accent"
                            />
                            <span className="ml-2 flex items-center"><Award className="mr-1" /> Researcher</span>
                        </label>
                        <label className="inline-flex items-center text-neutral-medium">
                            <input
                                type="radio"
                                ...
                                className="form-radio h-4 w-4 text-brand-accent bg-brand-primary border-brand-secondary focus:ring-brand-accent"
                            />
                            <span className="ml-2 flex items-center"><Person className="mr-1" /> Professional</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    <label className="inline-flex items-center">
                        ...
                        <span className="ml-2 text-neutral-medium text-sm">
                            I agree to the <Link to="/terms" className="text-brand-accent hover:underline">Terms & Conditions</Link> and <Link to="/privacy" className="text-brand-accent hover:underline">Privacy Policy</Link>.
                        </span>
                    </label>
                </div>
