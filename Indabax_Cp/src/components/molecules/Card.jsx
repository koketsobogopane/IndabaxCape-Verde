    ...
    return (
        ...
        >
            ...
            <div className="p-6 space-y-3"> {/* Adjusted spacing */}
                ...
                <h2 className="text-xl font-bold text-text-heading text-center"> {/* Smaller font, bold, text-text-heading */}
                    {title || "Card Title"}
                </h2>
                {/* Description (Role) */}
                <p className="text-brand-secondary font-semibold text-base text-center"> {/* brand-secondary for role, semibold */}
                    {description || "Role Description"}
                </p>
                {/* Additional Description (Bio) */}
                {additionalDescription && (
                    <p className="text-text-body text-sm leading-relaxed text-center"> {/* text-text-body for bio, smaller, relaxed leading */}
                        {additionalDescription}
                    </p>
                )}
            </div>
